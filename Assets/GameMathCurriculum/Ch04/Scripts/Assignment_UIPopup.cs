...
public class Assignment_UIPopup : MonoBehaviour
{
    ...
    private void UpdateAnimation()
    {
        ...
        {
            Image panel = popupPanel.GetComponent<Image>();

            canvasGroup.alpha = EaseOut(t);

            popupPanel.localScale = Vector3.one * EaseOut(t);
        ...
        else if (currentState == PopupState.Hiding)
        {
            ...
            canvasGroup.alpha = 1 - EaseIn(t);

            popupPanel.localScale = Vector3.one * (1 - EaseIn(t));
